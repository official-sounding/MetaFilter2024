        ...
        >
            <div
                @class([
                    ...
                    "mb-2 border-b border-gray-200 bg-gray-100 bg-gray-100 no-dark:bg-slate-800 no-dark:border-slate-900" => Helpers::isGithubTheme(),
                ])
            >
                <div
                    @class([
                    ...
                    <div class="flex items-center justify-center space-x-2">
                        ...
                        >
                            ...
                            <ul
                                ...
                                x-transition
                                class="absolute bottom-[1rem] right-[0.8rem] z-10 min-w-32 space-y-1 rounded border border-[gray-100] bg-white no-dark:border-slate-900 no-dark:bg-slate-800 p-1 shadow-lg"
                            >
                                @if ($this->canUpdateReply($reply))
                                    <li
                                        @click="
                                         ...
                                         "
                                        class="flex items-center space-x-2 rounded p-2 hover:!bg-gray-200 no-dark:hover:!bg-slate-900"
                                    >
                                ...
                                @if ($this->canDeleteReply($reply))
                                    <li
                                        ...
                                        class="flex items-center items-center space-x-2 space-x-2 rounded p-2 hover:!bg-gray-200 no-dark:hover:!bg-slate-900"
                                    >
