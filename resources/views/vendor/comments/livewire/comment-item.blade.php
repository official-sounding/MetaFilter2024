                        ...
                        <div class="flex items-center justify-center space-x-2">
                            ...
                            >
                                ...
                                <ul
                                    ...
                                    x-transition
                                    class="absolute bottom-[1rem] right-[0.8rem] z-10 min-w-32 space-y-1 rounded border  bg-white no-dark:border-slate-900 no-dark:bg-slate-800 p-1 shadow-lg"
                                >
                                    @if ($model->canEditComment($comment))
                                        <li
                                            ...
                                            @class([
                                                ...
                                                "flex items-center space-x-2 rounded p-2 no-dark:hover:!bg-slate-900"
                                            ])
                                        >
                                    ...
                                    @if ($model->canDeleteComment($comment))
                                        <li
                                            ...
                                            @class([
                                                "hover:!bg-[" . config('comments.hover_color') . "]",
                                                "flex items-center items-center space-x-2 space-x-2 rounded p-2 no-dark:hover:!bg-slate-900"
                                            ])
                                        >
                    ...
                    >
                        ...
                        >
                            <x-comments::link
                                type="popup"
                                @class([
                                    "mx-2 no-dark:!text-white inline-flex text-sm items-center transition no-dark:!bg-slate-900 no-dark:hover:!bg-slate-800 [&>*]:pr-1",
